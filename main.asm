...
NUM_CORRECT  EQU	d'55'  ; Holds the number of pairs of cards that have been correctly guessed. Although NUM_LEFT & NUM_CORRECT can be merged into one register, each register contains information
